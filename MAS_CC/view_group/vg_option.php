...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            <ul class="navbar-list">
                ...
                <li>
                    <a class="navbar-link" href="#">View Group</a>
                </li>
                <li>
    ...
    <div class="container">
        <h4 class="header1">View Group Type</h4>
        <div class="button">
            <div class="requestlist">
                <button><a href="see_pages.php">Groups Formed</a></button>
            </div>

            <div class=" rejectlist">
                <button><a href="../create_group/gm_rejected.php">Rejected List</a></button>
            </div>
        </div>
    </div>
    <footer>
