...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            <ul class="navbar-list">
                ...
                <li>
                    <a class="navbar-link" href="#">VIEW</a>
                </li>
                <li>
    ...
    <div class="container">
        <h4 class="header1">Group Type</h4>
        <div class="button">
            <div class="requestlist">
                <button><a href="see_pages.php">Created Groups</a></button>
            </div>

            <div class=" rejectlist">
                <button><a href="../create_group/gm_rejected.php">Rejected Members</a></button>
            </div>
        </div>
    </div>
    <footer>
